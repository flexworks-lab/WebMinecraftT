...
const cobblestoneMaterial = createTexture("#555555", ["#454545", "#686868", "#3f3f3f", "#737373"], 75, 18);
const gravelMaterial = createTexture("#74716a", ["#5e5b54", "#858178", "#626057", "#918d82"], 80, 19);
const sandMaterial = createTexture("#b9a568", ["#a89155", "#c9b77a", "#9d864c", "#d0c18b"], 54, 14);
const sandstoneMaterial = createTexture("#a9966a", ["#988455", "#b9a878", "#8f7b49", "#c5b58a"], 42, 20);
