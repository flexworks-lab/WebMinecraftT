...
@media(max-width:700px){#multiplayerChat{padding:14px!important;background:rgba(0,0,0,.78)!important}#multiplayerChat::before{font-size:25px!important;margin-bottom:10px!important}#multiplayerChatFeed{padding:11px 12px!important}.multiplayerChatLine{font-size:15px!important;line-height:1.5!important;margin:3px 0!important}#multiplayerChatInput{height:50px!important;flex-basis:50px!important;margin-top:10px!important;font-size:16px!important}#webMinecraftChatClose{display:block!important;visibility:visible!important;opacity:1!important}#webMinecraftChatNotifications{top:10px!important;left:10px!important;width:calc(100vw - 20px)!important}.webMinecraftChatNotification{font-size:14px!important;padding:7px 10px!important}}
`;
