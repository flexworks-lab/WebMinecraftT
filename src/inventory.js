...
.slotTexture{position:absolute;inset:6px;background-position:center;background-size:100% 100%;background-repeat:no-repeat;image-rendering:pixelated}.hotbarBlock3d{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;margin:0!important;left:auto!important;top:auto!important;right:auto!important;bottom:auto!important;display:block!important;transform:none!important;transform-style:flat;pointer-events:none;background:transparent!important;overflow:visible!important}.hotbarCube3d{position:absolute;left:50%;top:50%;width:34px;height:34px;margin-left:-17px;margin-top:-17px;display:block;transform:rotateX(-30deg) rotateY(45deg);transform-style:preserve-3d;transform-origin:center center;background:transparent}.hotbarCube3d .blockFace{position:absolute;left:0;top:0;width:34px;height:34px;display:block;margin:0;background-position:center;background-size:100% 100%;background-repeat:no-repeat;image-rendering:pixelated;backface-visibility:hidden;transform-style:preserve-3d;border:0}.hotbarCube3d .blockFront{transform:translateZ(17px);background-image:var(--block-front);filter:brightness(.95)}.hotbarCube3d .blockBack{transform:rotateY(180deg) translateZ(17px);background-image:var(--block-back)}.hotbarCube3d .blockRight{transform:rotateY(90deg) translateZ(17px);background-image:var(--block-right);filter:brightness(.78)}.hotbarCube3d .blockLeft{transform:rotateY(-90deg) translateZ(17px);background-image:var(--block-left);filter:brightness(.88)}.hotbarCube3d .blockTop{transform:rotateX(90deg) translateZ(17px);background-image:var(--block-top);filter:brightness(1.12)}.hotbarCube3d .blockBottom{transform:rotateX(-90deg) translateZ(17px);background-image:var(--block-bottom);filter:brightness(.62)}
