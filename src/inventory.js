...
.slotTexture{position:absolute;inset:6px;background-position:center;background-size:100% 100%;background-repeat:no-repeat;image-rendering:pixelated}.hotbarBlock3d{left:50%!important;top:50%!important;right:auto!important;bottom:auto!important;width:40px!important;height:40px!important;margin-left:-20px!important;margin-top:-20px!important;inset:auto!important;transform:rotateX(-30deg) rotateY(45deg);transform-style:preserve-3d;transform-origin:center center;pointer-events:none;background:transparent!important;overflow:visible!important}.hotbarBlock3d .blockFace{position:absolute;left:0;top:0;width:40px;height:40px;display:block;margin:0;background-position:center;background-size:100% 100%;background-repeat:no-repeat;image-rendering:pixelated;backface-visibility:hidden;transform-style:preserve-3d;border:0}.hotbarBlock3d .blockFront{transform:translateZ(20px);background-image:var(--block-front);filter:brightness(.95)}.hotbarBlock3d .blockBack{transform:rotateY(180deg) translateZ(20px);background-image:var(--block-back)}.hotbarBlock3d .blockRight{transform:rotateY(90deg) translateZ(20px);background-image:var(--block-right);filter:brightness(.78)}.hotbarBlock3d .blockLeft{transform:rotateY(-90deg) translateZ(20px);background-image:var(--block-left);filter:brightness(.88)}.hotbarBlock3d .blockTop{transform:rotateX(90deg) translateZ(20px);background-image:var(--block-top);filter:brightness(1.12)}.hotbarBlock3d .blockBottom{transform:rotateX(-90deg) translateZ(20px);background-image:var(--block-bottom);filter:brightness(.62)}
