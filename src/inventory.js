...
const ITEM_TYPES = [
    ...
    { id: 32, name: "Blast Furnace", texture: "blast_furnace_front.png", category: "natural" },
    ...
    { id: 168, name: "Crafting Table", texture: "crafting_table_front.png", category: "natural" },
...
#inventoryClose{width:38px;height:36px;border:2px solid #111;border-top-color:#aaa;border-left-color:#aaa;background:#8a8a8a;color:#fff;font-size:27px;line-height:25px;cursor:pointer;box-shadow:inset -2px -2px 0 #444}
#creativeTabs{display:flex;gap:6px;flex:0 0 auto;padding:0 3px 8px;border-bottom:2px solid #171717}
.inventoryTab{width:54px;height:48px;border:2px solid #161616;border-top-color:#8b8b8b;border-left-color:#8b8b8b;background:#777;color:#ddd;display:flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:inset -2px -2px 0 #444;position:relative}
...
button.catalogGroup{appearance:none;-webkit-appearance:none;padding:0;margin:0;font:inherit;color:inherit;text-align:left;outline:0}
...
.slotTexture{position:absolute;inset:6px;background-position:center;background-size:100% 100%;background-repeat:no-repeat;image-rendering:pixelated}.hotbarBlock3d{left:50%!important;top:50%!important;right:auto!important;bottom:auto!important;width:34px!important;height:34px!important;margin-left:-17px!important;margin-top:-17px!important;inset:auto!important;transform:translate3d(0,0,0) rotateX(-30deg) rotateY(45deg);transform-style:preserve-3d;transform-origin:center center;pointer-events:none;background:transparent!important;overflow:visible!important}.hotbarBlock3d .blockFace{position:absolute;left:0;top:0;width:34px;height:34px;display:block;margin:0;background-position:center;background-size:100% 100%;background-repeat:no-repeat;image-rendering:pixelated;backface-visibility:hidden;transform-style:preserve-3d;border:0}.hotbarBlock3d .blockFront{transform:translateZ(17px);background-image:var(--block-front);filter:brightness(.95)}.hotbarBlock3d .blockBack{transform:rotateY(180deg) translateZ(17px);background-image:var(--block-back)}.hotbarBlock3d .blockRight{transform:rotateY(90deg) translateZ(17px);background-image:var(--block-right);filter:brightness(.78)}.hotbarBlock3d .blockLeft{transform:rotateY(-90deg) translateZ(17px);background-image:var(--block-left);filter:brightness(.88)}.hotbarBlock3d .blockTop{transform:rotateX(90deg) translateZ(17px);background-image:var(--block-top);filter:brightness(1.12)}.hotbarBlock3d .blockBottom{transform:rotateX(-90deg) translateZ(17px);background-image:var(--block-bottom);filter:brightness(.62)}
...
#inventoryMobileButton{display:none;position:fixed;right:18px;bottom:84px;width:54px;height:54px;z-index:10001;border:2px solid #111;border-top-color:#aaa;border-left-color:#aaa;background:#777;color:#fff;font-size:27px;box-shadow:0 3px 0 #171717;touch-action:manipulation}
        ...
        if (slot?.itemId) {
            ...
            if (texture) {
                ...
                if (!slab && !stair && item) {
                    ...
                    textureEl.innerHTML = '<i class="blockFace blockFront"></i><i class="blockFace blockBack"></i><i class="blockFace blockRight"></i><i class="blockFace blockLeft"></i><i class="blockFace blockTop"></i><i class="blockFace blockBottom"></i>';
                } else {
