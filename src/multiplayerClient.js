...
function ensureMenu() {
    ...
    const showServerView = () => { selectedServer = null; setServerType(false); roomView.style.display = "none"; serverView.style.display = "block"; joinButton.disabled = true; stepServer.classList.add("active"); stepRoom.classList.remove("active"); setStatus(""); backButton.textContent = "Back"; overlay.querySelector("#multiplayerPanel")?.classList.add("servers-screen"); };
