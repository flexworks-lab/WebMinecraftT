...
function makeStyle() {
    ...
    style.textContent = `
        ...
        #multiplayerPanel.servers-screen #multiplayerButtons{position:absolute;top:14px;right:22px;z-index:3;padding:0;background:transparent;border:0}
...
function ensureMenu() {
    ...
    const showServerView = () => { closeServerDetails(); setServerType(false); roomView.style.display = "none"; serverView.style.display = "block"; joinButton.disabled = true; stepServer.classList.add("active"); stepRoom.classList.remove("active"); setStatus(""); backButton.textContent = "Back"; overlay.querySelector("#multiplayerPanel")?.classList.add("servers-screen"); };
...
export function openMultiplayerMenu() { ensureMenu(); overlay.style.display = "flex"; overlay.setAttribute("aria-hidden", "false"); overlay.querySelector("#multiplayerPanel")?.classList.add("servers-screen"); }
