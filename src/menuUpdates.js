...
function disableMotion() {
    ...
    style.textContent = `
        *, *::before, *::after {
        ...
        .seedButton:focus-visible,
        .pauseButton:focus-visible,
        #gameVersionButton:focus-visible,
        .gameVersionOption:focus-visible {
...
function setupUpdateDetails() {
    ...
    detailMenu.innerHTML = `
        <div id="updateDetailPanel">
            <div id="updateDetailBackWrap"><button id="updateDetailBack" class="seedButton" type="button">← Back</button></div>
