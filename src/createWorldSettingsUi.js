...
function injectStyle() {
    ...
    style.id = STYLE_ID;
    style.textContent = `
#savedWorlds[data-create-open="1"] .sw2-wrap > .sw2-head,#savedWorlds[data-create-open="1"] .sw2-wrap > .sw2-create-wrap,#savedWorlds[data-create-open="1"] .sw2-wrap > .sw2-body{display:none!important}\n#createWorldSettingsRoot{position:absolute;inset:0;width:100%;height:100%;display:flex;overflow:hidden;background:rgba(58,58,58,.10);color:#fff;font-family:Arial,sans-serif;border:0;box-shadow:inset 1px 1px 0 rgba(255,255,255,.05),inset -1px -1px 0 rgba(0,0,0,.16)}
#createWorldSettingsSidebar{width:315px;flex:0 0 315px;background:rgba(47,47,47,.10);border-right:2px solid #171717;display:flex;flex-direction:column;overflow:hidden}
